    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <button class="btn btn-danger btn-block btn-lg" onclick="gotochart1()" >Go to chart1</button>
                <button class="btn btn-danger btn-block btn-lg" onclick="gotochart2()" >Go to chart2</button>
